...
## Compare prior and posterior for $\theta = 0.1$, `n_sample = 250`, lognormal prior
...
result <- simulate(n_sample = 250, shape = shape, rate = shape, theta = theta, n_rep = 
                   n_repetitions, prior = "lognormal")
dat <- tibble(theta_watterson = result$theta_watterson,
              theta_bayes = result$theta_bayes,
              theta_lo = result$theta_lo,
              theta_hi = result$theta_hi)
